...
public class SessaoVotacaoApplicationService implements SessaoVotacaoService {
    ...
    @Override
    public SessaoAberturaResponse abreSessao(SessaoAberturaRequest sessaoAbertura) {
        log.info("[start] SessaoVotacaoApplicationService - abreSessao");
        Pauta pauta = pautaService.getPautaPorId(sessaoAbertura.getIdPauta());
        SessaoVotacao sessaoVotacao = sessaoVotacaoRepository.salva(new SessaoVotacao(sessaoAbertura, pauta));
